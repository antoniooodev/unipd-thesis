...
\input{UNIPDthesisFiles/fitbox2.sty}
...
\ifoptioncontains{/unipdthesis/debug}{spine}{%
...
}[\CalssError{unipdthesis}{Invalid spine angle: \thespine(angle)! Should be wither “0” or “180”.}{}]
...
\else\ifdim\@tempdima<0pt\relax%
  % spine DOES NOT FIT into paper height
    \ClassError{unipdthesis}{Spine is \the\@tempdima\space too long: \the\@spinelen\space instead of \the\paperheight}
...
\ifoptionequal{/unipdthesis/spine/layout}{none}{}{%
  \parindent=0pt%
  \sffamily%
  \linespread{0.85}%
  \normalsize%
  \ifdim\option{/unipdthesis/spine/width}=0pt\relax%
    ...
    \fi%
  \else%
    \@setlength{\@spinewidth}{\option{/unipdthesis/spine/width}}%
  ...
  \ifoptionequal{/unipdthesis/spine/layout}{trim}{%
    \stockwidth=\stockheight%
    \stockheight=\@spinewidth%
  }{\ifoptionequal{/unipdthesis/spine/layout}{full}{%
    \let\oldstockwidth=\stockwidth
    \stockwidth=\stockheight%
    \stockheight=21cm%
  }{%
    \ClassError{unipdthesis}{Unknown page dimensions for “spine/layout=\option{/unipdthesis/spine/layout}”}
  }}%
  ...
  \NTRunHook{spine/pre}%
  % \PAUSETHIS
  \ifoptionequal{/unipdthesis/spine/layout}{trim}{\@tempdima=0pt}{\@tempdima=\dimexpr(\stockheight-\@spinewidth)/2\relax}%
  \begin{tikzpicture}[remember picture, overlay,yscale=-1,yshift=-10.75pt+\@tempdima]%
    ...
    \datamatchtf{\arg}{spine}(%
      ...
      \ClassError{unipdthesis}{Undefined spine “bg,color”}{}%
    }%
    ...
    \ifoptionequal{/unipdthesis/spine/layout}{full}{%
      \datamatchtf{\arg}{spine}(%
        ...
        \ClassError{unipdthesis}{Undefined spine “frame,color”}{}%
      }%
    }{}%
    ...
    \datamatchtf{\arg}{thesiscover}({\@DOCTYPE,spine,image},{\@DOCCLASS,spine,image},{spine,image}){%
      \ifnotnone{\arg}{%
        ...
        \ClassError{unipdthesis}{Undefined spine “image”}{}%
      }%
    }%
    \@for\myi:=\expanded{\thespine(order)}\do{%
      ...
      \datamatchtf{\@align}{spine}({box,\myi,align},{\myi,align},{text,align}){}{%
        \ClassError{unipdthesis}{Invalid spine text alignment for “\myi”}{}%
      }%
      \IfStrEqCase{\@align}{%
  ...
  \end{tikzpicture}%
  \ifoptioncontains{/unipdthesis/DEBUG}{cover}{%
...
\newcommand{\printspinebox}[2]{%
  ...
  \datamatchtf{\@item}{spine}(%
                    ...
                    {#1,\@DOCTYPE},%
                    {#1}%
  ){}{\ClassError{unipdthesis}{Undefined spine element: #1}{}}%
