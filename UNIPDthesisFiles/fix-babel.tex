...
%%   unipdthesis.ldf file)… this must be fixed in the future!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\optionlistdo{/@nt/lang/short}{\options{/unipdthesis/babel/#1/keys/.new list}}

\def\mysplit#1/#2=#3\@nil#4#5#6{\def#4{#1}\def#5{#2}\def#6{#3}}
\newcommand{\ntlangsetup}{\@ifstar{\ntlangsetupifndef}{\ntlangsetupdef}}
\newcommand{\ntlangsetupdef}[2][name]{%
  \mysplit#2\@nil{\@ntslang}{\@ntskey}{\@ntsval}%
  % \typeout{KEY SET DEF (/unipdthesis/babel/\@ntslang/\@ntskey#1)=[\@ntsval]}%\KEYSETDEF%
  \ifoptiondefined{/unipdthesis/babel/\@ntslang/\@ntskey#1}{%
    \option@undef{/unipdthesis/babel/\@ntslang/\@ntskey#1}%
  }{}%
  \options{/unipdthesis/babel/\@ntslang/keys/.expanded/.newpush = \@ntskey#1#1}%
  \options{/unipdthesis/babel/\@ntslang/\@ntskey#1/.expanded/.new value = \@ntsval}%
}
\newcommand{\ntlangsetupifndef}[2][name]{%
  \mysplit#2\@nil{\@ntslang}{\@ntskey}{\@ntsval}%
  \ifoptioncontains{/unipdthesis/babel/\@ntslang/keys/.expanded}{\@ntskey#1}{}{%
    % \typeout{KEY SET IFNDEF (/unipdthesis/babel/\@ntslang/\@ntskey#1)=[\@ntsval]}\KEYSETDEF%
    % \typeout{KEY SET IFNDEF (/unipdthesis/babel/\@ntslang/\@ntskey)=[\@ntsval]}%
    \options{/unipdthesis/babel/\@ntslang/keys/.expanded/.newpush = \@ntskey#1}%
    \options{/unipdthesis/babel/\@ntslang/\@ntskey#1/.expanded/.new value = \@ntsval}%
  }
}
...
\AtEndPreamble{%
  \optionlistdo{/@nt/lang/loaded}{%
    \optionlistdo{/unipdthesis/babel/#1/keys}{%
      % \typeout{KEY SET2 (#1/##1)=[\option{/unipdthesis/babel/#1/##1}]}%\KEYSETTWO%
      \setlocalecaption{\thelanglong(#1)}{##1}{\option{/unipdthesis/babel/#1/##1}}%
    }%
  }%
}
