...
%%      at: https://github.com/BIRSAx2/unipdthesis/
%%
...
%%          https://github.com/BIRSAx2/unipdthesis/discussions
%%      or at the NOVAthesis facebook group at
%%          https://www.facebook.com/groups/unipdthesis
%%      or in the subreddit r/unipdthesis
%%          https://www.reddit.com/r/unipdthesis/
%%
%% AUTHOR @github:
%%      - BIRSAx2
%%
%% CONTRIBUTORS @github:
%%      https://github.com/BIRSAx2/unipdthesis/wiki#help-with-the-project-patches-and-new-features
%%
%% DONATIONS:
...
%%
%% CITATION:
%%      If you use this template, please be kind and \cite{unipdthesis-manual} somewhere in your document.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%------------------------------------------------------------
%% The unipdthesis class is based in “memoir”.  To set memoir
%%  options, edit “Config/0_memoir.tex”.
\RequirePackage{UNIPDthesisFiles/fix-profiling}
\benchmarktic
\documentclass{unipdthesis}
...
%      Please open and edit the appropriate
%       configuration file “Config/1_unipdthesis.tex”
%============================================================
...
\ntprint{dedicatory}      
\benchmarktoc
\typeout{TIME process dedicatory=\the\pdfelapsedtime}%
%%------------------------------------------------------------
%% Print acknowledgements
\benchmarktic
\ntprint{acknowledgements}     
\benchmarktoc
\typeout{TIME process dedicatory=\the\pdfelapsedtime}%
%%------------------------------------------------------------
%% Print quote
